...
public class JLightningRpc extends UnixDomainSocketRpc {
	...
	/**
	* Return feerate estimates,  either satoshi-per-kw {perkw} or satoshi-per-kb {perkb}
	* @param style
	* @return
	*/ 
	public String feerates(String style){
                HashMap<String, String> payload = new HashMap<String,String> ();
		payload.put("style", style);
		return this.call("feerates", payload);
	}
	...
	*/
	...
	public String connect(String node_id, String host){
                HashMap<String, String> payload = new HashMap<String,String> ();
                payload.put("id", node_id);
	 ...
	 /**
        * Delete all expired invoices that expired as of given {maxexpirytime}, or all expired invoices if not specified 
        * @param maxexpirytime 
        */

        public String delexpiredinvoice(int maxexpirytime){
                HashMap<String, String> payload = new HashMap<String,String> ();
